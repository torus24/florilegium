...
| 04 | [When the chain stops itself](04-when-the-chain-stops-itself.md) | The ceiling is a shutdown, not a quota: no unit left half-done | [ADR-0007](../architecture/decisions/0007-run-limits-are-shutdowns.md) · [ADR-0005](../architecture/decisions/0005-cost-is-intrinsic-to-quality.md) |
