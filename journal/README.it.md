...
| 04 | [Quando la catena si spegne da sola](04-when-the-chain-stops-itself.it.md) | Il tetto è uno spegnimento, non una quota: nessuna unità lasciata a metà | [ADR-0007](../architecture/decisions/0007-run-limits-are-shutdowns.it.md) · [ADR-0005](../architecture/decisions/0005-cost-is-intrinsic-to-quality.it.md) |
